...
export default {
  ...
  data() {
    return {
      ...
      zoneSelect: [
        { text: "บางโพ", value: "บางโพ" },
        { text: "เตาปูน", value: "เตาปูน" },
        { text: "บางซ่อน", value: "บางซ่อน" },
        { text: "วงศ์สว่าง", value: "วงศ์สว่าง" },
        { text: "สะพานควาย", value: "สะพานควาย" },
        { text: "ราชปรารภ-ราชเทวี", value: "ราชปรารภ-ราชเทวี" },
        { text: "สนามเป้า", value: "สนามเป้า" },
        { text: "ปิ่นเกล้า/จรัญ", value: "ปิ่นเกล้า/จรัญ" },
        { text: "จตุจักร", value: "จตุจักร" },
        { text: "ศรีนครินทร์", value: "ศรีนครินทร์" },
        { text: "รามคำแหง - หัวหมาก", value: "รามคำแหง - หัวหมาก" },
        { text: "พัฒนาการ", value: "พัฒนาการ" },
        { text: "BTS สำโรง", value: "BTS สำโรง" },
        { text: "ลาดกระบัง", value: "ลาดกระบัง" },
        { text: "BTS เอราวัณ", value: "BTS เอราวัณ" },
        { text: "BTS ปู่เจ้า", value: "BTS ปู่เจ้า" },
        { text: "BTS บางนา", value: "BTS บางนา" },
        { text: "BTS แบร์ริ่ง", value: "BTS แบร์ริ่ง" },
        { text: "BTS อุดมสุข", value: "BTS อุดมสุข" },
        { text: "BTS ปุณณวิถี", value: "BTS ปุณณวิถี" },
        { text: "BTS บางจาก", value: "BTS บางจาก" },
        { text: "BTS อ่อนนุช", value: "BTS อ่อนนุช" },
        { text: "BTS พระโขนง", value: "BTS พระโขนง" },
        { text: "พระราม 4", value: "พระราม 4" },
        { text: "BTS เอกมัย", value: "BTS เอกมัย" },
        { text: "BTS ทองหล่อ", value: "BTS ทองหล่อ" },
        { text: "BTS พร้อมพงษ์", value: "BTS พร้อมพงษ์" },
        { text: "เจริญนคร", value: "เจริญนคร" },
        { text: "บางแค", value: "บางแค" },
        { text: "วงเวียนใหญ่", value: "วงเวียนใหญ่" },
        { text: "ท่าพระ", value: "ท่าพระ" },
        { text: "สีลม", value: "สีลม" },
        { text: "พระราม 3", value: "พระราม 3" },
        { text: "สามย่าน", value: "สามย่าน" },
        { text: "เจริญกรุง", value: "เจริญกรุง" },
        { text: "ราษฎร์บูรณะ", value: "ราษฎร์บูรณะ" },
        { text: "สาทร", value: "สาทร" },
        { text: "Airport Link หัวหมาก", value: "Airport Link หัวหมาก" },
        { text: "แยกพระราม9-รามคำแหง", value: "แยกพระราม9-รามคำแหง" },
        { text: "เกษตร", value: "เกษตร" },
        { text: "รัชโยธิน", value: "รัชโยธิน" },
        { text: "ศูนย์วัฒนะธรรม", value: "ศูนย์วัฒนะธรรม" },
        { text: "ลาดพร้าว", value: "ลาดพร้าว" },
        { text: "สุทธิสาร", value: "สุทธิสาร" },
        { text: "ห้วยขวาง", value: "ห้วยขวาง" },
        { text: "พระราม9", value: "พระราม9" },
        { text: "เพชรบุรี", value: "เพชรบุรี" },
        { text: "อโศก", value: "อโศก" },
      ],
      // transportBTSSelect: [
